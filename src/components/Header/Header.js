...
const Logo = () => (
  ...
  >
    ...
    <g transform="translate(0 4)">
      <circle cx="16" cy="16" r="16" fill="#E3262E" />

      {/* Road */}
      <path
        d="M15 31L18 31L20 7H13L15 31Z"
        fill="white"
      />

      {/* Road markings */}
      <rect x="15.3" y="10" width="2" height="3" rx="1" fill="#E3262E" />
      <rect x="15.3" y="16" width="2" height="3" rx="1" fill="#E3262E" />
      <rect x="15.3" y="22" width="2" height="3" rx="1" fill="#E3262E" />
    </g>
      ...
      <div className="app-header__inner">
        ...
        <nav className="app-header__actions">
          {isLoggedIn ? (
            ...
            <Link to="/login" className="app-header__btn app-header__btn--primary">
              Login
            </Link>
          )}
        </nav>
